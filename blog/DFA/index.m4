...
_HEADER_HL1(`[Z3][SMT][Python] (Mostly for CS geeks) constructing minimal DFA accepting specific binary numbers')

<p>A problem: construct a regular expression accepting binary number divisible by 3.</p>

<p>"1111011" (123) is, "101010101011" (2731) is not.</p>

<p>Some discussion and the correct expressions:</p>

<ul>
<li>_HTML_LINK_AS_IS(`https://stackoverflow.com/questions/7974655/regex-for-binary-multiple-of-3')
<li>_HTML_LINK_AS_IS(`https://stackoverflow.com/questions/844867/check-if-a-number-is-divisible-by-3')
<li>_HTML_LINK_AS_IS(`https://stackoverflow.com/questions/867279/regular-expression-to-define-some-binary-sequence')
<li>_HTML_LINK_AS_IS(`https://www.regextester.com/96234')
</ul>

<p>I couldn't generate RE, but I can generate minimal DFA (Deterministic finite automaton):</p>
...
<p>... is almost like the one someone posted _HTML_LINK(`https://stackoverflow.com/questions/7974655/regex-for-binary-multiple-of-3',`here'),
but my solution has two separate states as initial and accepting.</p>
...
<p>Divisible by 9. Probably not an easy thing to find it manually:</p>
<p><img src="9.png"></p>

<p>Divisible by 10. Not a prime, so the DFA is smaller:</p>
<p><img src="10.png"></p>

<p>These DFAs are guaranteed to be minimal.
Further work: convert them to RE...</p>
