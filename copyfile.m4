...
<p>_HTML_LINK(`http://conus.info/attic-files/copyfile/copyfile.exe', `Download/Скачать')</p>

<p>_HTML_LINK(`https://github.com/dennis714/Copyfile', `Source code/Исходный код')</p>
