...
<p><a href="//yurichev.com/non-wiki-files/blog/exploits/oracle/CVE-2010-0071.py_.txt">Here is PoC</a> (Python script). It is not full exploit, what it do is: while running on 11.1.0.7.0 win32, nsglvcrt() Listener function attempt to allocate huge memory block and copy *something* to it.</p>
