...
<p>There was Cointerra Bitcoin miner, looking like _HTML_LINK(`http://yurichev.com/blog/bitcoin_miner/board.jpg',`that').</p>

<p>And there was also (possibly leaked) _HTML_LINK(`http://yurichev.com/blog/bitcoin_miner/cointool-overclock',`utility') which can set clock rate for the board.
