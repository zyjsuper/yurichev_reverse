...
<p>( The source code: _HTML_LINK_AS_IS(`https://github.com/DennisYurichev/yurichev.com/blob/master/blog/stable_marriage/stable.py') )</p>
...
<p>( The source code: _HTML_LINK_AS_IS(`https://github.com/DennisYurichev/yurichev.com/blob/master/blog/stable_marriage/stable2.py') )</p>
